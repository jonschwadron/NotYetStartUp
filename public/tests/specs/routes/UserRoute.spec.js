describe('User Route', function() {
  ...
  beforeEach(module('NotyetStartup'));

  beforeEach(inject(function(_$location_, _$route_, $templateCache,
    _$rootScope_) {
    $route = _$route_;
    $rootScope = _$rootScope_;
    $location = _$location_;

    $templateCache.put('src/notyetstartup/login/tmpl/login.html', '');
  }));
  ...
  it('should be defined with correct controller and templateUrl', function() {
    ...
    expect($route.current.templateUrl).toEqual(
      'src/notyetstartup/login/tmpl/login.html');
  });
});
