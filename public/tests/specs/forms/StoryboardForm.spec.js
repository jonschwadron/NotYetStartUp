...
describe('Storyboard form', function() {
  ...
  beforeEach(module('NotyetStartup.Storyboard'));
  beforeEach(module('NotyetStartup.Templates'));

  beforeEach(inject(function($q, $rootScope, $controller, $templateCache,
    $compile) {
    var UsersModel = {
      all: function() {
    ...
    var templateHtml = $templateCache.get(
      'src/angello/storyboard/tmpl/storyboard.html');
